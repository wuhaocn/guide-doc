!(function() {
	if ('undefined' != typeof self && self.Prism && self.document) {
		...
		Prism.hooks.add('before-highlight', function(t) {
			...
			if (t.element.querySelector('.command-line-prompt'))
				return (n.complete = !0), void 0
			var o = t.code.split('\n')
			...
			Prism.hooks.add('before-insert', function(e) {
				...
				if (!a.complete) {
					for (
						...
						a.outputLines.hasOwnProperty(r) &&
							(n[r] = a.outputLines[r])
			...
			Prism.hooks.add('complete', function(t) {
				...
				if (!n.complete) {
					...
					var o = function(e, t) {
							return (r.getAttribute(e) || t).replace(
								/"/g,
								'&quot'
							)
						},
						...
						i = o('data-prompt', '')
					if ('' !== i)
						s = s.join('<span data-prompt="' + i + '"></span>')
					else {
					...
					t.element.insertBefore(d, t.element.firstChild),
						(n.complete = !0)
				}
			})
	}
