...
docker rm mysql3336
docker run --privileged=true --name mysql3336 -p 3336:3306 -e MYSQL_ROOT_PASSWORD=urcs@2018 -d mysql:5.6.40
docker update mysql3336 --restart=always

docker stop mysql3337
docker rm mysql3337
docker run --privileged=true --name mysql3337 -p 3337:3306 -e MYSQL_ROOT_PASSWORD=urcs@2018 -d mysql:5.6.40
