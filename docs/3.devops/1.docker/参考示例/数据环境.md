...
docker run --privileged=true --name mysql.5.6.40 -p 3306:3306 -e MYSQL_ROOT_PASSWORD=urcs@2018 -d mysql:5.6.40
...
docker run --privileged=true --name mysql3306 -p 3306:3306 -e MYSQL_ROOT_PASSWORD=urcs@2018 -d mysql:5.6.40

docker update mysql3306 --restart=always

docker stop mysql3307

docker rm mysql3307

docker run --privileged=true --name mysql3307 -p 3307:3306 -e MYSQL_ROOT_PASSWORD=urcs@2018 -d mysql:5.6.40

docker update mysql3307 --restart=always
...
docker run -d --name coral-drawhubdb -p 3306:3306 -e MYSQL_ROOT_PASSWORD=coral@2018 mysql:5.6.40
